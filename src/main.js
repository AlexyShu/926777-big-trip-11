...
//Форма (окно с описанием и offers)
...
// Обертка всех карточек одного дня
...
//верхняя часть с городами маршрута и total price
const createTripInfoTemplate = () => {
  return (`
    <section class="trip-main__trip-info  trip-info">
       <div class="trip-info__main">
         <h1 class="trip-info__title">Amsterdam &mdash; Chamonix &mdash; Geneva</h
...
.fill(``)
.forEach(() => render(siteEventListElement, createCardTemplate(), `beforeend`));
